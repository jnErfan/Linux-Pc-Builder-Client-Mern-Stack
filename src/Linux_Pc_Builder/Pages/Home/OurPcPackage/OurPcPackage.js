...
const OurPcPackage = () => {
  ...
  // Home Page Get 6 Desktop Package From Database
  useEffect(() => {
    fetch(`https://linux-pc-builder-backend.herokuapp.com/desktopsPagination?page=0&size=6`)
      .then((res) => res.json())
  ...
  //  Send  Cart Order  Information Database
